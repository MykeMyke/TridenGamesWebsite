export const resDMbios = [
  ...
  },
  {
    name: "Liam James ",
    superpowers:
      "Running seven campaigns and a weekly one shot at the same time. ",
  ...
  {
    name: "Griffmeister",
    superpowers: "Nat 20 death saves.  ",
    favMonster: "Griffon or Hippogriff of course",
    favMoment:
  ...
  },
  {
    name: "Corgibutt",
    superpowers:
      "Jumping from one server to another and keeping track of the games I'm running or playing in each of them",
    favMonster: "Bodaks",
    favMoment:
  ...
  {
    name: "Shane H",
    superpowers: "I'm just making it all up as I go along",
    favMonster: "Star Spawn Mangler",
    favMoment:
  ...
  {
    name: "Daran",
    superpowers: "Fostering party chicanery",
    favMonster: "Pixie",
    favMoment:
  ...
  {
    name: "Malte",
    superpowers: "Making sure a good time is had by all",
    favMonster: "You'll find out...",
    favMoment: "",
    otherInterests:
      "Swing music, Balboa dancing, HomeOffice while travelling, German Spitz, writing code to make my and others' life easy.",
    link1name: "",
    link2name: "",
    link1: "",
    link2: "",
